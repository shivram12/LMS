            ...
            <table class="table">
                ...
                <c:forEach var="book" items="${books}">
                    <tr>
                        ...
                        <td><a href="update-book?id=${book.id}"><div class="glyphicon glyphicon-pencil"></div>Edit</a></td>
                        <td><a href="delete-book?id=${book.id}"><div class="glyphicon glyphicon-trash"></div> Delete</a></td>
